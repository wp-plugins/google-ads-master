...
// HOOK WIDGET
require_once('includes/google-ads-master-widget.php');
	...
	class google_ads_master{
		...
		*/
		public static function options_page()
		{
			...
			include(self::file_path('includes/google-ads-master-admin.php'));
		}
		/** function/method
		* Usage: show options/settings form page
		* Arg(0): null
		...
		*/
		...
		{
			// display widget page
			include(self::file_path('includes/google-ads-master-widget.php'));
		}
		/** function/method
