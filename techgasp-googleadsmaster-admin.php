<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/google-ads-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - Google Ads Master Lite Version</b></h2>
<form method="post" action="techgasp-googleadsmaster-admin.php"> 
...
<img src="../wp-content/plugins/google-ads-master/techgasp-googleadsmaster-logo.png" alt="Google Ads Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>Google Ads Master:</h2></p>
<p>Google Ads Master for wordpress is the <b>professional plugin</b> you need to generate income with your website.</p>
</br>
<p><em>The income maker for any Wordpress Administrator. Let the money flow in.</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. Google Ads Master Widget:</b></p>
<p>Select or <em>"add"</em > Google Ads Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert Google Ads Master Widget inside Pages and Posts (advanced version only):</b></p>
<p>Copy and Paste this shortcode inside your pages or posts [googleadsmaster id=xx] replace xx with your sidebar number, ie [googleadsmaster id=sidebar-1]</p>
<p><a class="button-primary" href="widgets.php" title="Widgets Page">To Widgets Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/google-ads-master/" target="_blank" title="More Help">More Help</a> <a class="button-primary" href="http://wordpress.techgasp.com/google-ads-master/" target="_blank" title="Google Ads Master Advanced Version">Google Ads Master Advanced Version</a></p>
<hr>
<p><h3>Google Ads Master Advanced Version Contains:</h3></p>
<p>Display or hide Widget Title. Display or hide Google Adsense ads. Insert desired google ad (allows ads styling). Shortcode Framework, publish widget inside pages and posts.</p>
