...
<tr>
<td width="387">
<img src="<?php echo plugins_url('../images/techgasp-googleadsmaster-logo.png', __FILE__); ?>" alt="Google Ads Master" align="left" width="387px" height="171px" style="padding:5px;"/>
</td>
<td width="0,5"></td>
<td width="670">
...
<h2><?php _e("Google Ads Master LITE Version", 'google_ads_master'); ?></h2>
<br>
<form method="post" width='1'>
<fieldset class="options">
<legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Advanced Version Updater:', 'google_ads_master'); ?></h3></legend>
<br>
<div class="description">Only available in <b>Google Ads Master Advanced Version</b>.</div>
<p><a class="button-primary" href="http://wordpress.techgasp.com/google-ads-master/" target="_blank" title="Google Ads Master Advanced Version">Advanced Version</a></p>
</fieldset>
<p class="submit"><input class='button-primary' type='submit' name='update' value='<?php _e("Save Settings", 'google_ads_master'); ?>' id='submitbutton' /></p>
...
<div class="description">All widget options are available in your widgets page. <b>Google Ads Master Widget</b>.</div>
...
<div class="description">The shortcode framework allows you to insert Google Ads inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Google Ads Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>

<h3><img src="<?php echo plugins_url('../images/techgasp-minilogo.png', __FILE__); ?>" style="width:40px; vertical-align:middle;" alt="' . esc_attr__( 'TechGasp Plugins') . '" /> Google Ads Master Website</h3>
<p><a class="button-secondary" href="http://wordpress.techgasp.com/google-ads-master/" target="_blank" title="Google Ads Master Info Page">Info Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/google-ads-master-documentation/" target="_blank" title="Google Ads Master Documentation">Documentation</a> <a class="button-primary" href="http://wordpress.techgasp.com/google-ads-master/" target="_blank" title="Google Ads Master Advanced Version">Advanced Version</a></p>
</form>
</div>