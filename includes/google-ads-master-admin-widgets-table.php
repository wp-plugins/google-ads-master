...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-googleadsmaster-admin-widget-viral.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('google_ads_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-googleadsmaster-admin-widget-ads.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('google_ads_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
